...
$issueNo 				=	$SubFunction->allTags($_GET['no']);
if(!$issueNo){
...
<!--						</span>-->
						...
						<div class="tabGroup conRadioSort mt15">
							<ul>
								...
								<li>
									<div class="radioCase">
										<div class="radioIconBox">
											<input type="radio" name="isRegularCheck" value="2">
											<label></label>
										</div>
					...
					<div class="btnGroup">
						<a href="javascript:update_issue();" class="btn f_white bg_navy">저장</a>
					</div>
				</form>
			</div>
		</div>
...
<script src="/issue/js/issueSpec.js"></script>
